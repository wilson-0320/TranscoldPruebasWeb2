                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <asp:DropDownList ID="ddlCamara" CssClass="form-control" runat="server"></asp:DropDownList>
                                    </div>
                                    <div class="col-sm-2">

                                        <small>Tipo Prueba</small>
                                        <asp:DropDownList ID="ddlTipoPrueba" CssClass="form-control" runat="server"></asp:DropDownList>
