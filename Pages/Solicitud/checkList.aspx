                ...
                <section class="content">
                    ...
                    <div class="container-fluid">
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                <div class="modal fade" id="modalCheck" data-backdrop="static" name="modal">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row" style="display:block;" id="1">
                        <div class="col-lg-4">
              ...
              <asp:LinkButton ID="lbtnEliminarCrud" runat="server" ToolTip="Eliminar" CssClass=" fa  fa-trash" CommandArgument='<%# Eval("ID") %>' OnClientClick="return confirm('¿Realmente desea eliminar el registro?')" CommandName="EliminarRecepcion">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td class="bg-gradient-navy">Haladores</td>
    ...
    <script>
...

        {
            ...
            if (boton == "btnSig") {
                ...
                if (index === 15) {
                    metodo("Si estas seguro, puedes guardar el registro", 2);
                } else { index = index + 1; }
            } else {
                if (index === 1) {
                    metodo("No existe opciones, debes de presionar el boton de siguiente.", 2);
                }
                else { index = index - 1; }
